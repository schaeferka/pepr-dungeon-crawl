...
const color slimeColor =            {70,    70,     40,     0,      0,          0,          10,     false};
...
const floorTileType tileCatalog[NUMBER_TILETYPES] = {
    ...
    {G_FLOOR_ALT,    &slimeColor,            0,                      80, 0,  DF_PLAIN_FIRE,  0,          0,              100,            NO_LIGHT,       (0), (TM_STAND_IN_TILE | TM_VANISHES_UPON_PROMOTION),                                               "a puddle of slime",    "a puddle of slime covers the ground."},
...
creatureType monsterCatalog[NUMBER_MONSTER_KINDS] = {
    ...
    {0, "rat",          G_RAT,    &gray,          6,      0,      80,     {1, 3, 1},      20, 100,    100,    DF_RED_BLOOD,   0,    false,      1,      DF_SLIME,       {0}},
    {0, "kobold",       G_KOBOLD,    &goblinColor,   7,      0,      80,     {1, 4, 1},      20, 100,    100,    DF_RED_BLOOD,   0,    false,      0,      0,              {0}},
    {0, "jackal",       G_JACKAL,    &jackalColor,   8,      0,      70,     {2, 4, 1},      20, 50,     100,    DF_RED_BLOOD,   0,    false,      1,      DF_SLIME,              {0}},
    ...
    {0, "monkey",       G_MONKEY,    &ogreColor,     12,     17,     100,    {1, 3, 1},      20, 100,    100,    DF_RED_BLOOD,   0,    false,      1,      DF_SLIME,       {0},
        (0), (MA_HIT_STEAL_FLEE)},
