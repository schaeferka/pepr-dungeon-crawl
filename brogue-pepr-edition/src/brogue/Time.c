...
void updateVolumetricMedia(void) {
...
void updateYendorWardenTracking(void) {
    short n;
...
void processIncrementalAutoID(void) {
...
void monstersApproachStairs(void) {
    short n;
...
void decrementPlayerStatus(void) {
    // Handle hunger.
